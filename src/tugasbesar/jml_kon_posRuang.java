...
public class jml_kon_posRuang extends identitas {
	...
	String analisis_kelistrikan() {
		if (getPosisi_steker().equalsIgnoreCase("a") && getJml_steker() >= 4 && steker == 4) {
			hasil = "Sesuai";
		} else {
		hasil = "Tidak sesuai";
		}
	...
	String analisis_LCD() {
		if (getJml_kabelLCD() >= 1 && getKondisi_kabelLCD().equalsIgnoreCase("berfungsi") && getPosisi_kabelLCD().equalsIgnoreCase("a")) {
			hasil = "Sesuai";
		} else {
			hasil = "Tidak sesuai";
		}
	...
	String analisis_lampu() {
		if (getJml_lampu() >= 18 && lampu == 18 && getPosisi_lampu().equalsIgnoreCase("a")) {
			hasil = "Sesuai";
		} else {
			hasil = "Tidak sesuai";
		}
	...
	String analisis_kipas_angin() {
		if (getJml_kipas() >= 2 && kipas == 2 && getPosisi_kipas().equalsIgnoreCase("a")) {
			hasil = "Sesuai";
		} else {
			hasil = "Tidak sesuai";
		}
	...
	String analisis_AC() {
		if (getJml_AC() >= 1 && AC >= 1 && getPosisi_AC().equalsIgnoreCase("a") && getPosisi_AC().equalsIgnoreCase("b")) {
			hasil = "Sesuai";
		} else {
			hasil = "Tidak sesuai";
		}
	...
	String analisis_internet() {
		if (getBandwitdth().equalsIgnoreCase("a") && getLogin().equalsIgnoreCase("baik")) {
			hasil = "Sesuai";
		} else {
			hasil = "Tidak sesuai";
		}
	...
	String analisis_CCTV() {
		if (getJml_CCTV() == 2 && CCTV == 2  && getPosisi_CCTV().equalsIgnoreCase("a")) {
			hasil = "Sesuai";
		} else {
			hasil = "Tidak sesuai";
		}
