...
public class lingkunganRuang extends identitas{
	...
	String analisis_kebersihan() {
		if (getKondisi_lantai().equalsIgnoreCase("bersih") && getKondisi_dinding().equalsIgnoreCase("bersih") && getKondisi_atap().equalsIgnoreCase("bersih") && getKondisi_pintu().equalsIgnoreCase("bersih") && getKondisi_jendela().equalsIgnoreCase("bersih")) {
			hasil = "Sesuai";
		} else {
			hasil = "Tidak sesuai";
		}
